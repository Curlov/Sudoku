        ...
        <div class ="footer">
           ...
           <form id="gamePlay" action="index.php" method="post">
               ...
               <div class="button-group-numbers">
                   <input id="ButtonNumber1" type="submit" class="buttonNumbers" name="number" value="1">
                   <input id="ButtonNumber2" type="submit" class="buttonNumbers" name="number" value="2">
                   <input id="ButtonNumber3" type="submit" class="buttonNumbers" name="number" value="3">
                   <input id="ButtonNumber4" type="submit" class="buttonNumbers" name="number" value="4">
                   <input id="ButtonNumber5" type="submit" class="buttonNumbers" name="number" value="5">
                   <input id="ButtonNumber6" type="submit" class="buttonNumbers" name="number" value="6">
                   <input id="ButtonNumber7" type="submit" class="buttonNumbers" name="number" value="7">
                   <input id="ButtonNumber8" type="submit" class="buttonNumbers" name="number" value="8">
                   <input id="ButtonNumber9" type="submit" class="buttonNumbers" name="number" value="9">
               </div>
           </form>
        </div>
    </div>
